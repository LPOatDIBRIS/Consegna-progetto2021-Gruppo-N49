...
public class BufferedTokenizer implements Tokenizer {
	...
	static { // initialization of the symbol and keyword tables: symbols and keywords are singleton lexical categories 
		...
		symbols.put("[", OPEN_SQUARE);						//NEW ADD
		symbols.put("]", CLOSE_SQUARE); 					//NEW ADD
		symbols.put(":", RANGE);							//NEW ADD
		...
		keywords.put("bounds",BOUNDS);						//NEW ADD
		keywords.put("for",FOR);							//NEW ADD
		keywords.put("in",IN);								//NEW ADD 
	}
